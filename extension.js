...
let chest_pins = MAPS_PinLoad.filter((value) => value.name?.includes('보물상자'));
const handlers = Symbol('handlers');
function makeObservable(targetData) {
...
function addChestPinEvent() {
    ...
    observable_chest_pins.subscribe((property, isPinLoaded) => {
